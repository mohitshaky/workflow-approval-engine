...
@Getter
public class WorkflowNotificationEvent extends WorkflowEvent {
    private final WorkflowInstance workflowInstance;
    private final WorkflowStep workflowStep;
    
    public WorkflowNotificationEvent(WorkflowInstance workflowInstance, WorkflowStep workflowStep) {
